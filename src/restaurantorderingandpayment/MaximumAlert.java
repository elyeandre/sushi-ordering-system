 ...
 */
public class MaximumAlert extends javax.swing.JDialog {
     private Point initialClick;
    /**
     * Creates new form ShowConfirmDIalog
     */
    public MaximumAlert(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MainPanel.add(NoButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 80, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/restaurantorderingandpayment/images/information.png"))); // NOI18N
        MainPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 40, 30));
        ...
        PleaseFIll.setText("Input must be 1-100");
        MainPanel.add(PleaseFIll, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 220, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaximumAlert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaximumAlert dialog = new MaximumAlert(new javax.swing.JFrame(), true);
