 ...
 */
public class QuantityAlert extends javax.swing.JDialog {
     private Point initialClick;
    /**
     * Creates new form ShowConfirmDIalog
     */
    public QuantityAlert(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MainPanel.add(NoButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 80, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/restaurantorderingandpayment/images/error.png"))); // NOI18N
        MainPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 30, 30));
        ...
        PleaseFIll.setText("Please Input quantity!");
        MainPanel.add(PleaseFIll, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 190, 30));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(MainPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(MainPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuantityAlert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuantityAlert dialog = new QuantityAlert(new javax.swing.JFrame(), true);
