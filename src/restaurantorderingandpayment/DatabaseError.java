 ...
 */
public class DatabaseError extends javax.swing.JDialog {
   
     
    /**
     * Creates new form ShowConfirmDIalog
     */
    public DatabaseError(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/restaurantorderingandpayment/images/database.png"))); // NOI18N
        ...
        PleaseFIll.setText("Database connection error");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DatabaseError dialog = new DatabaseError(new javax.swing.JFrame(), true);
