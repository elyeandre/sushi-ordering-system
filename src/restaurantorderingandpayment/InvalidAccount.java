 ...
 */
public class InvalidAccount extends javax.swing.JDialog {
     private Point initialClick;
    /**
     * Creates new form ShowConfirmDIalog
     */
    public InvalidAccount(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        PleaseFIll.setText("User not found!");
        MainPanel.add(PleaseFIll, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 250, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvalidAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InvalidAccount dialog = new InvalidAccount(new javax.swing.JFrame(), true);
