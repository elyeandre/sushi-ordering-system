 ...
 */
public class CartIsEmptyAlert extends javax.swing.JDialog {
     private Point initialClick;
    /**
     * Creates new form ShowConfirmDIalog
     */
    public CartIsEmptyAlert(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MainPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 40, 30));
        ...
        PleaseFIll.setText("Cart is empty!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CartIsEmptyAlert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CartIsEmptyAlert dialog = new CartIsEmptyAlert(new javax.swing.JFrame(), true);
